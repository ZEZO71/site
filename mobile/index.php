...
<div style="height:20px;"><div style="display:none; color:#666666;" id="cp">CPF</div></div>
<div style=""><input type="tel" name="cpfis" id="cpfis" value="CPF" onfocus="clean(this.id)" onblur="blurCPF(this.id)" onClick="oculto('cp')" size="30" maxlength="11" onKeyUp="javascript:pulacampo('cpf','bt')" autocomplete="off"></div>
...
<div style="text-align:center; margin-top:-40px;"><a href="atualiza.php"><button class="btn btn-primary" type="button"> Saiba mais <span class="badge"><span class="glyphicon glyphicon-chevron-right"></span></span></button></a></div>
</div>
